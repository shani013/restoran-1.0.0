                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body d-flex justify-content-between custom-btn" >
                                    <pack class='card-title'>New Product</pack>
                                    <div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body d-flex justify-content-between custom-btn" >
                                    <pack class='card-title'>New Chef</pack>
                                    <div>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addchefs" >
                                            <i class="bi bi-plus-circle"></i>
                                        </button>
                                    </div>
                                </div>
